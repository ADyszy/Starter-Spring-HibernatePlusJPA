...
insert into library (id, name) values (2, 'Biblioteka Wiejska');
insert into library (id, name) values (3, 'Biblioteka Swiatowa');
...
insert into book (id, title, library_id) values (4, 'Czwarta książka', 1);
